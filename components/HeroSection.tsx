...
const tags = ["Building Materials","Channel Sales","FMCG / Paints","Financial Services","Dealer Network","Team Leadership","M.Com – JNVU"];

export default function HeroSection() {
  return (
    <section id="about" className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ paddingTop: "80px", paddingBottom: "60px" }}>
      ...
      <div className="section-wrap relative z-10 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            {[1,2].map(i => (
              <div key={i} className="absolute rounded-full"
                style={{
                  ...
                  borderRadius: "50%",
                  animation: `pulse-ring ${1.8 * i}s ease-out ${i * 0.5}s infinite`
                }} />
            ))}

            {/* Photo */}
            <div className="relative w-full h-full rounded-full overflow-hidden z-10"
              style={{ border: "3px solid rgba(201,168,76,0.5)", boxShadow: "0 0 40px rgba(26,86,219,0.4), 0 0 80px rgba(201,168,76,0.15)" }}>
              <Image
                src="/sanjay.png"
                alt="Sanjay Panwar"
                fill
            ...
            {/* Online dot */}
            <div className="absolute z-20 w-5 h-5 bg-green-400 rounded-full flex items-center justify-center"
              style={{ bottom: "6px", right: "6px", border: "3px solid #080f1e", boxShadow: "0 0 10px rgba(34,197,94,0.6)" }}>
              <div className="w-full h-full rounded-full bg-green-400" style={{ animation: "pulse-ring 2s ease-out infinite" }} />
            </div>
          </motion.div>
